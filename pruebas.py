...
from dao_pruebas.prueba_reserva_dao import (
    reserva_dao_create,
    reserva_dao_findall,
    reserva_dao_findById,
    reserva_dao_update,
)
...
def inicio_pruebas():
    """
    Inicia las pruebas sobre los distintos DAOs (Clientes, Salones, Reserva, Tipo Cocina, Tipo Reserva).
    Conecta a la base de datos y ejecuta las pruebas correspondientes.
    """
...
def reserva_dao_pruebas(conexion):
    """
    Ejecuta las pruebas para el DAO de Reserva.
    """
...
def cliente_dao_pruebas(conexion):
    """
    Ejecuta las pruebas para el DAO de Cliente.
    """
...
def tipo_reserva_dao_pruebas(conexion):
    """
    Ejecuta las pruebas para el DAO de Tipo Reserva.
    """
...
def salones_dao_pruebas(conexion):
    """
    Ejecuta las pruebas para el DAO de Salones.
    """
...
def tipo_cocina_dao_pruebas(conexion):
    """
    Ejecuta las pruebas para el DAO de Tipo Cocina.
    """
